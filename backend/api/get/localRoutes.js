...
const defaultSettings = require('../../public/defaultServer.json');
...
router.get('/invite-bot/:serverId', (req, res) => {
    ...
    res.redirect(`https://discord.com/oauth2/authorize?client_id=${botToken}&permissions=76800&scope=bot&guild_id=${serverId}&response_type=code&redirect_uri=http://localhost:8081/callback`);
});
